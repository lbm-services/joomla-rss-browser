 ...
 * (webtour enabled 2008 by H.Lindlbauer, info@lbm-services.de)
...
var homepath=""; // set this var to your Joomla root dir, e.g. "/joomla"

// on page load call TB_init
window.addEvent('domready', TB_init);
// override getHeight-Function for Opera-compatibility
...
function TB_show(caption, url, rel) {
	...
	if ( !$("TB_overlay") )
	{
		...
		$('TB_load').innerHTML = "<img src='"+homepath+"/modules/mod_thick_rss/images/loadingAnimation.gif' />";
		TB_load_position();
